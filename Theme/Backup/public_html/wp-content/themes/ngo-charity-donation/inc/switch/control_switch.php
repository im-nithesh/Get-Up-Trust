 ...
 * Control - Switch.
 *
 * @package NGO Charity Donation Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class NGO_Charity_Donation_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'ngo-charity-donation-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'ngo-charity-donation-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
