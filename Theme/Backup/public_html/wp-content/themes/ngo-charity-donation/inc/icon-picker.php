...
class Ngo_Charity_Donation_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'ngo-charity-donation' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $ngo_charity_donation_font_awesome_icon_array = ngo_charity_donation_font_awesome_icon_array();
                    foreach ($ngo_charity_donation_font_awesome_icon_array as $ngo_charity_donation_font_awesome_icon) {
                            $icon_class = $this->value() == $ngo_charity_donation_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($ngo_charity_donation_font_awesome_icon).'"></i>
                            <span class="ngo-charity-donation-social-class">'.esc_attr($ngo_charity_donation_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function ngo_charity_donation_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'ngo-charity-donation-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'ngo_charity_donation_customizer_script' );

if(!function_exists('ngo_charity_donation_font_awesome_icon_array')){
    function ngo_charity_donation_font_awesome_icon_array(){
